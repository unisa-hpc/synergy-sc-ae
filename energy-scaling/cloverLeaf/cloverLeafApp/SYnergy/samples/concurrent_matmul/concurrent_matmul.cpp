...
#ifdef SYNERGY_ENABLE_PROFILING
  std::cout << "Device (q1) Energy consumption: " << q1.get_synergy_device().get_energy_consumption() << " j\n";
  std::cout << "Device (q2) Energy consumption: " << q2.get_synergy_device().get_energy_consumption() << " j\n";
#endif
}