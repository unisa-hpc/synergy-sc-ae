...
void build_field(global_variables &globals) {
	...
	for (int tile = 0; tile < globals.config.tiles_per_chunk; ++tile) {
		...
		clover::execute(globals.queue, "build_field_1",[&](cl::sycl::handler &h) {
		...
		clover::execute(globals.queue, "build_field_3", [&](cl::sycl::handler &h) {
		...
		clover::execute(globals.queue, "build_field_4", [&](cl::sycl::handler &h) {
		...
		clover::execute(globals.queue, "build_field_5", [&](cl::sycl::handler &h) {
		...
		clover::execute(globals.queue, "build_field_6", [&](cl::sycl::handler &h) {
		...
		clover::execute(globals.queue,"build_field_7", [&](cl::sycl::handler &h) {
		...
		clover::execute(globals.queue,"build_field_8", [&](cl::sycl::handler &h) {
