...
void update_tile_halo_l_kernel(
	...
	if (fields[field_density0] == 1) {
		...
		clover::execute(1107, 1155,q, "update_tile_halo", [&](handler &h) {
	...
	if (fields[field_density1] == 1) {
		// DO k=y_min-depth,y_max+depth
		clover::execute(1107, 1162,q, "update_tile_halo", [&](handler &h) {
	...
	if (fields[field_pressure] == 1) {
		// DO k=y_min-depth,y_max+depth
		clover::execute(1107, 1117,q, "update_tile_halo", [&](handler &h) {
...
void update_tile_halo_t_kernel(
	...
	if (fields[field_xvel1] == 1) {
		for (int k = 0; k < depth; ++k) {
			// DO j=x_min-depth, x_max+1+depth
			clover::execute(1107, 1140,q, "update_tile_halo", [&](handler &h) {
	...
	if (fields[field_yvel1] == 1) {
		for (int k = 0; k < depth; ++k) {
			// DO j=x_min-depth, x_max+1+depth
			clover::execute(1107, 1147,q, "update_tile_halo", [&](handler &h) {
...
void update_tile_halo_b_kernel(
	...
	if (fields[field_energy0] == 1) {
		for (int k = 0; k < depth; ++k) {
			//  DO j=x_min-depth, x_max+depth
			clover::execute(1107, 825,q, "update_tile_halo", [&](handler &h) {
	...
	if (fields[field_pressure] == 1) {
		for (int k = 0; k < depth; ++k) {
			//  DO j=x_min-depth, x_max+depth
			clover::execute(1107, 1222,q, "update_tile_halo", [&](handler &h) {
