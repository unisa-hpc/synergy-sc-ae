...
test_kernel_name = ['accelerate_features.csv', 'advec_cell_features.csv', 'advec_mom_features.csv',
                    'advection_features.csv','build_field_features.csv', 'calc_dt_features.csv', 
                    'clover_leaf_features.csv','comms_features.csv', 'field_summary_features.csv', 
                    'flux_calc_features.csv', 'generate_chunk_features.csv', 'hydro_features.csv', 
                    'ideal_gas_features.csv', 'initialise_chunk_features.csv',
                    'initialise_features.csv', 'pack_kernel_features.csv', 'PdV_features.csv',
                    'read_input_features.csv', 'report_features.csv','reset_field_features.csv', 
                    'revert_features.csv', 'start_features.csv', 'timer_features.csv',
                    'timestep_features.csv', 'update_halo_features.csv', 'update_tile_halo_features.csv',
                    'update_tile_halo_kernel_features.csv', 'viscosity_features.csv', 'visit_features.csv']
