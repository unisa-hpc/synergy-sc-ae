...
python3 $SCRIPT_DIR/postprocess/merge.py $SCRIPT_DIR/parsed_metrics $SCRIPT_DIR/micro/features-normalized $SCRIPT_DIR/../models-validation/data/training-data
