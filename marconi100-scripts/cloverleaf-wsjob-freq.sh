...
proc=$(( $nodes*4 ))
size=$(( $proc*32 ))
mpirun -n $proc -gpu /m100/home/userexternal/lcarpent/cloverleaf-executable-versions/${executable} --file /m100/home/userexternal/lcarpent/cloverleaf_sycl/input_files/clover_bm${size}_short.in
